      ...
      <div className="min-h-screen bg-background">
        ...
        <div className="flex items-center justify-center min-h-screen px-4 pt-16">
          <div className="max-w-md text-center">
            <div className="flex items-center justify-center w-24 h-24 mx-auto mb-6 rounded-full bg-error-50">
              <Icon name="AlertCircle" size={48} className="text-error" />
            </div>
            <h1 className="mb-4 text-2xl font-heading font-heading-medium text-text-primary">
              Order Not Found
            </h1>
              ...
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center space-x-4">
                  <button
                    ...
                    className="flex items-center px-4 py-2 space-x-2 border rounded-lg border-border text-text-secondary hover:text-primary hover:border-primary transition-smooth font-body font-body-medium"
                  >
                  ...
                  <button
                    ...
                    className="flex items-center px-4 py-2 space-x-2 text-white rounded-lg bg-primary hover:bg-primary-700 transition-smooth font-body font-body-medium"
                  >
              ...
              <div className="space-y-6">
                ...
                {currentOrder.type === "delivery" &&
                  currentOrder.deliveryInstructions && (
                    <div className="p-6 border bg-accent-50 rounded-xl border-accent-200">
                      <h3 className="mb-3 text-lg font-heading font-heading-medium text-text-primary">
                        Delivery Instructions
                      </h3>
                      <p className="text-text-secondary font-body">
                        {currentOrder.deliveryInstructions}
