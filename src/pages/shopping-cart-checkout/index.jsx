...
function ShoppingCartCheckout() {
  ...
  return (
    <>
      <Helmet>
        <title>TasteBite | Shopping Cart</title>
      </Helmet>
          ...
          <div className="px-4 py-8 mx-auto max-w-7xl sm:px-6 lg:px-8">
            ...
            {cartItems.length === 0 ? (
              ...
              <div className="py-16 text-center">
                <div className="flex items-center justify-center w-24 h-24 mx-auto mb-6 rounded-full bg-secondary-100">
                  <Icon
                    name="ShoppingCart"
                    size={48}
                ...
                <h2 className="mb-4 text-2xl font-heading font-heading-medium text-text-primary">
                  Your cart is empty
                </h2>
                <p className="mb-8 text-text-secondary font-body">
                  Add some delicious items to get started
                </p>
                <Link
                  to="/menu-browse-search"
                  className="inline-flex items-center px-6 py-3 space-x-2 text-white rounded-lg bg-primary hover:bg-primary-700 transition-smooth font-body font-body-medium"
                >
              ...
              <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
                ...
                <div className="space-y-6 lg:col-span-2">
                  ...
                  {!isMinimumMet && (
                    <div className="p-4 border rounded-lg bg-warning-50 border-warning-200">
                  ...
                  <div className="space-y-4">
                    {cartItems.map((item) => (
                      <div
                        key={item.id}
                        className="p-6 border rounded-lg bg-surface border-border shadow-soft"
                      >
                          ...
                          <div className="flex-1">
                            <div className="flex items-start justify-between">
                              ...
                              <div className="flex items-center space-x-3">
                                <button
                                  ...
                                  className="flex items-center justify-center w-8 h-8 border rounded-lg border-border hover:bg-secondary-50 transition-smooth"
                                >
                                  <Icon name="Minus" size={16} />
                                </button>
                                <span className="w-8 text-lg text-center font-data font-data-normal">
                                  {item.quantity}
                                </span>
                                <button
                                  onClick={() =>
                            ...
                            {item.customizations.length > 0 && (
                              <button
                                ...
                                className="flex items-center mt-2 space-x-2 text-sm text-text-secondary hover:text-primary transition-smooth"
                              >
                                <Icon
                                  name={
                                ...
                                <div className="flex flex-wrap gap-2">
                                  {item.customizations.map(
                                    (customization, index) => (
                                      <span
                                        key={index}
                                        className="px-2 py-1 text-sm rounded-md bg-primary-50 text-primary font-body"
                                      >
                                        {customization}
                                      </span>
                                    )
                            ...
                            <div className="flex items-center justify-between mt-4">
                              ...
                              <div className="flex items-center space-x-4">
                                ...
                                <button
                                  ...
                                  className="p-1 rounded text-error hover:bg-error-50 transition-smooth"
                                >
                  ...
                  {/* Promo Code */}
                  <div className="p-6 border rounded-lg bg-surface border-border shadow-soft">
                    <h3 className="mb-4 text-lg font-heading font-heading-medium text-text-primary">
                      Promo Code
                    </h3>
                    <div className="flex space-x-3">
                      <input
                        ...
                        className="flex-1 px-3 py-2 border rounded-lg border-border focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent font-body"
                      />
                      <button
                        onClick={applyPromoCode}
                        className="px-6 py-2 text-white rounded-lg bg-primary hover:bg-primary-700 transition-smooth font-body font-body-medium"
                      >
                        Apply
                      </button>
                    </div>
                ...
                <div className="space-y-6">
                  ...
                  {fulfillmentType === "delivery" && (
                    <div className="p-6 border rounded-lg bg-surface border-border shadow-soft">
                      ...
                      <select
                        ...
                        className="w-full px-3 py-2 border rounded-lg border-border focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent font-body"
                      >
                  ...
                  <div className="p-6 border rounded-lg bg-surface border-border shadow-soft">
                    ...
                    <div className="p-3 mt-4 rounded-lg bg-accent-50">
                      <div className="flex items-center space-x-2">
                  ...
                  <div className="p-6 border rounded-lg bg-surface border-border shadow-soft">
                    ...
                    <div className="flex items-center justify-between mb-3">
                      ...
                      <span className="text-lg font-data font-data-normal text-primary">
                        {loyaltyPoints}
                      </span>
                    </div>
                  ...
                  <div className="p-6 border rounded-lg bg-surface border-border shadow-soft">
                    ...
                    <textarea
                      ...
                      rows={3}
                      className="w-full px-3 py-2 border rounded-lg resize-none border-border focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent font-body"
                    />
                  </div>
                  ...
                  <button
                    ...
                    className="flex items-center justify-center w-full px-6 py-4 space-x-2 text-lg text-white rounded-lg bg-primary hover:bg-primary-700 disabled:opacity-50 disabled:cursor-not-allowed transition-smooth font-body font-body-medium"
                  >
                    {isLoading && (
