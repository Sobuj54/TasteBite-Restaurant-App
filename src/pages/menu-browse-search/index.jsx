    ...
    <>
      ...
      <div className="min-h-screen bg-background">
        ...
        <main className="pt-16">
          {/* Search Header */}
          <div className="sticky border-b top-16 z-dropdown bg-surface shadow-soft border-border">
            <div className="px-4 py-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
              ...
              <div className="flex items-center justify-between mb-4">
                ...
                <button
                  ...
                  className="flex items-center px-4 py-2 space-x-2 border rounded-lg border-border hover:bg-secondary-50 transition-smooth lg:hidden"
                >
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full py-3 pl-10 pr-4 border rounded-lg border-border focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent font-body"
                />
                {searchQuery && (
                  <button
              ...
              {activeFiltersCount > 0 && (
                <div className="flex flex-wrap items-center mt-3 space-x-2">
                  ...
                  {filters.dietary.map((diet) => (
                    <span
                      key={diet}
                      className="inline-flex items-center px-2 py-1 space-x-1 text-xs rounded-full bg-primary-100 text-primary font-body"
                    >
            ...
            <div className="flex gap-6">
              ...
              <div className="flex-shrink-0 hidden w-64 lg:block">
                <div className="sticky p-6 rounded-lg bg-surface shadow-soft top-32">
                  ...
                  {/* Dietary Preferences */}
                  <div className="mb-6">
                    <h4 className="mb-3 font-body font-body-medium text-text-primary">
                      Dietary Preferences
                    </h4>
                    <div className="space-y-2">
                      {[
                        ...
                        >
                          ...
                          />
                          <span className="text-sm capitalize font-body text-text-secondary">
                            {diet.replace("-", " ")}
                          </span>
                        </label>
                      ))}
              ...
              <div className="flex-1">
                {/* Category Tabs */}
                <div className="mb-6">
                  <div className="flex pb-2 space-x-1 overflow-x-auto scrollbar-hide">
                ...
                {isLoading ? (
                  <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
                    {[...Array(6)].map((_, index) => (
                      <div
                        key={index}
                        className="overflow-hidden rounded-lg bg-surface shadow-soft animate-pulse"
                      >
                        <div className="h-48 bg-secondary-200"></div>
                        <div className="p-4 space-y-3">
                          <div className="w-3/4 h-4 rounded bg-secondary-200"></div>
                          <div className="w-full h-3 rounded bg-secondary-200"></div>
                          <div className="w-2/3 h-3 rounded bg-secondary-200"></div>
                          <div className="w-1/3 h-8 rounded bg-secondary-200"></div>
                        </div>
                      </div>
                    ))}
                  </div>
                  ...
                  <div className="py-12 text-center">
                    <div className="flex items-center justify-center w-24 h-24 mx-auto mb-4 rounded-full bg-secondary-100">
                      <Icon
                        name="Search"
                        size={32}
                    ...
                    <h3 className="mb-2 text-lg font-heading font-heading-medium text-text-primary">
                      No items found
                    </h3>
                    <p className="mb-4 text-text-secondary font-body">
                      Try adjusting your search or filters to find what you're
                      looking for.
                    </p>
                    <button
                      onClick={clearFilters}
                      className="px-4 py-2 text-white rounded-lg bg-primary hover:bg-primary-700 transition-smooth font-body font-body-medium"
                    >
                      Clear filters
                    </button>
                  </div>
                      ...
                      >
                        ...
                        <div className="relative h-48 overflow-hidden">
                          ...
                          <div className="absolute flex flex-col space-y-2 top-3 left-3">
                            {item.isPopular && (
                              <span className="px-2 py-1 text-xs text-white rounded-full bg-accent font-body font-body-medium">
                                Popular
                              </span>
                            )}
                            {item.discount && (
                              <span className="px-2 py-1 text-xs text-white rounded-full bg-error font-body font-body-medium">
                                {item.discount}
                              </span>
                            )}
                          </div>
                          ...
                          {item.isAvailable && (
                            <button
                              ...
                              className="absolute flex items-center justify-center w-10 h-10 text-white transition-opacity rounded-full opacity-0 bottom-3 right-3 bg-primary group-hover:opacity-100 hover:bg-primary-700"
                            >
                          ...
                          {/* Unavailable Overlay */}
                          {!item.isAvailable && (
                            <div className="absolute inset-0 flex items-center justify-center bg-opacity-50 bg-secondary-900">
                              <span className="px-3 py-1 text-sm rounded-full bg-surface text-text-primary font-body font-body-medium">
                        ...
                        <div className="p-4">
                          ...
                          <div className="flex items-start justify-between mb-2">
                            ...
                            <div className="flex items-center space-x-1 text-sm">
                              <Icon
                                name="Star"
                                size={14}
                                className="fill-current text-warning-400"
                              />
                          ...
                          {/* Description */}
                          <p className="mb-3 text-sm text-text-secondary font-body line-clamp-2">
                            {item.description}
                          </p>
                          ...
                          <div className="flex items-center mb-3 space-x-3">
                            ...
                            <div className="flex items-center space-x-1">
                              {item.dietary.slice(0, 2).map((diet) => (
                                <div
                                  key={diet}
                                  className="flex items-center justify-center w-5 h-5 rounded-full bg-success-100"
                                  title={diet}
                                >
                                  <Icon
                          ...
                          <div className="flex items-center justify-between">
                            <div className="flex items-center space-x-2">
                              ...
                              {item.originalPrice && (
                                <span className="text-sm line-through text-text-secondary font-body">
                                  ${item.originalPrice}
                                </span>
                              )}
                            </div>
                            ...
                            {item.isAvailable && (
                              <button
                                ...
                                className="px-3 py-1 text-sm rounded-lg bg-primary-50 text-primary hover:bg-primary-100 transition-smooth font-body font-body-medium"
                              >
                                Add
                              </button>
                            )}
        ...
        {isFilterOpen && (
          <div className="fixed inset-0 z-modal lg:hidden">
            <div
              className="fixed inset-0 bg-opacity-50 bg-secondary-900"
            ...
            <div className="fixed inset-x-0 bottom-0 bg-surface rounded-t-2xl shadow-floating max-h-[80vh] overflow-y-auto">
              <div className="p-6">
                ...
                {/* Action Buttons */}
                <div className="flex pt-6 mt-6 space-x-3 border-t border-border">
                  <button
                    onClick={clearFilters}
                    className="flex-1 px-4 py-3 border rounded-lg border-border text-text-secondary hover:bg-secondary-50 transition-smooth font-body font-body-medium"
                  >
                    Clear All
                  </button>
                  <button
                    onClick={() => setIsFilterOpen(false)}
                    className="flex-1 px-4 py-3 text-white rounded-lg bg-primary hover:bg-primary-700 transition-smooth font-body font-body-medium"
                  >
                    Apply Filters
                  </button>
                </div>
